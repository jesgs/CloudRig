...
class CloudCustomPropertiesMixin:
	...
	def generate_properties_bone(self) -> BoneInfo:
		...
		return properties_bone
<<<<<<<< HEAD:rig_component_features/custom_props.py
========
...
>>>>>>>> a3a545f (Hard commit to calling rigs/rig elements "components" or "rig components", in folders, files, comments, variable names, UI, absolutely everywhere.):rig_component_features/custom_properties.py
