...
class CloudJawRig(CloudCopyRig):
	...
	"""Hierarchy:
		...
		Jaw (bone that owns the rig element)
	...
	def create_bone_infos(self):
		...
		# Not yet sure what's the best way to make the user define the elements of the jaw rig
		# and therefore not sure what's the best way to grab the bone info here.
		# For now, let's do this: The other rig elements are expected to be cloud_copy bones, 
