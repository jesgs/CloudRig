...
from ..rig_component_features.ui import redraw_viewport, get_addon_prefs, is_cloud_metarig
...
from .cloudrig import ensure_custom_panels, register_hotkey, is_active_cloud_metarig, is_active_cloudrig
...
class CloudRig_Generator:
    ...
    def instantiate_rig_components(self) -> Dict[str, Component_Base]:
        ...
        for pb in component_bones_ordered:
            ...
            if parent_component:
                parent_instance = comp_map.get(parent_component.base_bone_name)
        ...
        for bi in self.bone_infos:
            ...
            if not pose_bone:
                self.logger.log("Bone creation failed"
                    ,base_bone_name   = bi.owner_component.base_bone
