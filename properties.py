...
class ComponentParams(PropertyGroup):
    # TODO 4.0: Some params would have to be grabbed from the rig_component_features package.
...
class RigComponent(PropertyGroup):
    ...
    def update_ui_bone_sets(self, context):
...
class Properties_CloudRig(PropertyGroup):
    ...
    active_component_index: IntProperty(description="Active CloudRig Component", update=active_component_update_callback)
