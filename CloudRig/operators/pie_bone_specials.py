...
from bpy.types import Context, EditBone, Menu, Object, Operator, PoseBone
...
def remove_drivers_of_bone(rig: Object, bone_name: str):
    """Remove all drivers on the rig or its data that reference the given bone name."""
    datablocks = []
